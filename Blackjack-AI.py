...
bouton_v = Button(fenetre, text="Valider la main", width=15, height=2, bg="grey7", fg="dodger blue", command=valider,
                  relief=FLAT)
# On crée le bouton pour passer son tour
bouton_v.place(x=600, y=255)
bouton_r = Button(fenetre, text="Rejouer", width=15, height=2, bg="grey7", fg="spring green", command=rejouer,
                  relief=FLAT)
